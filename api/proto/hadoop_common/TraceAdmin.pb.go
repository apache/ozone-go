...
func (*ListSpanReceiversRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*SpanReceiverListInfo) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*ListSpanReceiversResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*ConfigPair) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*AddSpanReceiverRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*AddSpanReceiverResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*RemoveSpanReceiverRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*RemoveSpanReceiverResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func init() { proto.RegisterFile("TraceAdmin.proto", fileDescriptor1) }
