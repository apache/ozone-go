...
func (*GenericRefreshRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func (*GenericRefreshResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{1} }
...
func init() { proto.RegisterFile("GenericRefreshProtocol.proto", fileDescriptor12) }
