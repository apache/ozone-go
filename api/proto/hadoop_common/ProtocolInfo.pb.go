...
func (*GetProtocolVersionsRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*ProtocolVersionProto) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*ProtocolSignatureProto) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{5} }
...
func init() { proto.RegisterFile("ProtocolInfo.proto", fileDescriptor7) }
