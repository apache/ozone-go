...
func (*RefreshCallQueueRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*RefreshCallQueueResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func init() { proto.RegisterFile("RefreshCallQueueProtocol.proto", fileDescriptor5) }
