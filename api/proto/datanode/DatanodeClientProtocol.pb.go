...
const (
	...
	Result_CHUNK_FILE_INCONSISTENCY        Result = 43
)
...
type ReadChunkVersion int32

const (
	ReadChunkVersion_V0 ReadChunkVersion = 0 // Response data is sent in a single ByteBuffer
	ReadChunkVersion_V1 ReadChunkVersion = 1 // Response data is split into multiple buffers
)

// Enum value maps for ReadChunkVersion.
var (
	ReadChunkVersion_name = map[int32]string{
		0: "V0",
		1: "V1",
	}
	ReadChunkVersion_value = map[string]int32{
		"V0": 0,
		"V1": 1,
	}
)

func (x ReadChunkVersion) Enum() *ReadChunkVersion {
	p := new(ReadChunkVersion)
	*p = x
	return p
}

func (x ReadChunkVersion) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReadChunkVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_DatanodeClientProtocol_proto_enumTypes[4].Descriptor()
}

func (ReadChunkVersion) Type() protoreflect.EnumType {
	return &file_DatanodeClientProtocol_proto_enumTypes[4]
}

func (x ReadChunkVersion) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *ReadChunkVersion) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = ReadChunkVersion(num)
	return nil
}

// Deprecated: Use ReadChunkVersion.Descriptor instead.
func (ReadChunkVersion) EnumDescriptor() ([]byte, []int) {
...
func (ContainerDataProto_State) Descriptor() protoreflect.EnumDescriptor {
	return file_DatanodeClientProtocol_proto_enumTypes[5].Descriptor()
}

func (ContainerDataProto_State) Type() protoreflect.EnumType {
	return &file_DatanodeClientProtocol_proto_enumTypes[5]
}
...
type ContainerCommandRequestProto struct {
	...
	Version                 *uint32                              `protobuf:"varint,24,opt,name=version" json:"version,omitempty"`
}
...
func (x *ContainerCommandRequestProto) GetVersion() uint32 {
...
type ChunkInfoList struct {
	...
	Chunks []*ChunkInfo `protobuf:"bytes,1,rep,name=chunks" json:"chunks,omitempty"`
}
...
func (x *ChunkInfoList) GetChunks() []*ChunkInfo {
	if x != nil {
		return x.Chunks
	}
	return nil
...
type ReadChunkRequestProto struct {
	...
	BlockID          *DatanodeBlockID  `protobuf:"bytes,1,req,name=blockID" json:"blockID,omitempty"`
	ChunkData        *ChunkInfo        `protobuf:"bytes,2,req,name=chunkData" json:"chunkData,omitempty"`
	ReadChunkVersion *ReadChunkVersion `protobuf:"varint,3,opt,name=readChunkVersion,enum=hadoop.hdds.datanode.ReadChunkVersion" json:"readChunkVersion,omitempty"`
}
...
func (x *ReadChunkRequestProto) GetReadChunkVersion() ReadChunkVersion {
	if x != nil && x.ReadChunkVersion != nil {
		return *x.ReadChunkVersion
	}
	return ReadChunkVersion_V0
}
...
type ReadChunkResponseProto struct {
	...
	//	*ReadChunkResponseProto_Data
	//	*ReadChunkResponseProto_DataBuffers
	ResponseData isReadChunkResponseProto_ResponseData `protobuf_oneof:"responseData"`
}
...
func (m *ReadChunkResponseProto) GetResponseData() isReadChunkResponseProto_ResponseData {
	if m != nil {
...
func (x *ReadChunkResponseProto) GetData() []byte {
	if x, ok := x.GetResponseData().(*ReadChunkResponseProto_Data); ok {
		return x.Data
	}
	return nil
}

func (x *ReadChunkResponseProto) GetDataBuffers() *DataBuffers {
	if x, ok := x.GetResponseData().(*ReadChunkResponseProto_DataBuffers); ok {
		return x.DataBuffers
	}
	return nil
}

type isReadChunkResponseProto_ResponseData interface {
	isReadChunkResponseProto_ResponseData()
}

type ReadChunkResponseProto_Data struct {
	Data []byte `protobuf:"bytes,3,opt,name=data,oneof"` // Chunk data is returned as single buffer for V0
}

type ReadChunkResponseProto_DataBuffers struct {
	DataBuffers *DataBuffers `protobuf:"bytes,4,opt,name=dataBuffers,oneof"` // Chunk data is returned as a list of buffers
}

func (*ReadChunkResponseProto_Data) isReadChunkResponseProto_ResponseData() {}

func (*ReadChunkResponseProto_DataBuffers) isReadChunkResponseProto_ResponseData() {}
...
type DataBuffers struct {
	...
	Buffers [][]byte `protobuf:"bytes,1,rep,name=buffers" json:"buffers,omitempty"`
}

func (x *DataBuffers) Reset() {
	*x = DataBuffers{}
	if protoimpl.UnsafeEnabled {
...
func (x *DataBuffers) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataBuffers) ProtoMessage() {}

func (x *DataBuffers) ProtoReflect() protoreflect.Message {
	mi := &file_DatanodeClientProtocol_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataBuffers.ProtoReflect.Descriptor instead.
func (*DataBuffers) Descriptor() ([]byte, []int) {
	return file_DatanodeClientProtocol_proto_rawDescGZIP(), []int{36}
}

func (x *DataBuffers) GetBuffers() [][]byte {
	if x != nil {
		return x.Buffers
	}
	return nil
...
type GetSmallFileRequestProto struct {
	...
	ReadChunkVersion *ReadChunkVersion     `protobuf:"varint,2,opt,name=readChunkVersion,enum=hadoop.hdds.datanode.ReadChunkVersion" json:"readChunkVersion,omitempty"`
}
...
func (x *GetSmallFileRequestProto) GetReadChunkVersion() ReadChunkVersion {
	if x != nil && x.ReadChunkVersion != nil {
		return *x.ReadChunkVersion
	}
	return ReadChunkVersion_V0
...
func (x *CopyContainerRequestProto) Reset() {
	*x = CopyContainerRequestProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_DatanodeClientProtocol_proto_msgTypes[45]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CopyContainerRequestProto) Descriptor() ([]byte, []int) {
	return file_DatanodeClientProtocol_proto_rawDescGZIP(), []int{45}
}
...
func (x *CopyContainerRequestProto) GetVersion() uint32 {
	if x != nil && x.Version != nil {
		return *x.Version
	}
	return 0
...
func (x *CopyContainerResponseProto) Reset() {
	*x = CopyContainerResponseProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_DatanodeClientProtocol_proto_msgTypes[46]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CopyContainerResponseProto) Descriptor() ([]byte, []int) {
	return file_DatanodeClientProtocol_proto_rawDescGZIP(), []int{46}
}
...
var file_DatanodeClientProtocol_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xaf, 0x0d, 0x0a, 0x1c, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x43,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x44, 0x52, 0x07, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x44, 0x22, 0x89, 0x01, 0x0a, 0x24,
	0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x50,
	...
	,
	...
	,
	...
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x68, 0x65, 0x63,
	0x6b, 0x73, 0x75, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x09, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x22, 0xac, 0x01, 0x0a, 0x16, 0x57, 0x72, 0x69, 0x74, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x2f, 0x64, 0x61, 0x74, 0x61, 0x6e, 0x6f, 0x64, 0x65, 0xa0, 0x01, 0x01,
}
...
var file_DatanodeClientProtocol_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_DatanodeClientProtocol_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_DatanodeClientProtocol_proto_goTypes = []interface{}{
	...
	(ReadChunkVersion)(0),                        // 4: hadoop.hdds.datanode.ReadChunkVersion
	(ContainerDataProto_State)(0),                // 5: hadoop.hdds.datanode.ContainerDataProto.State
	(*DatanodeBlockID)(nil),                      // 6: hadoop.hdds.datanode.DatanodeBlockID
	(*KeyValue)(nil),                             // 7: hadoop.hdds.datanode.KeyValue
	(*ContainerCommandRequestProto)(nil),         // 8: hadoop.hdds.datanode.ContainerCommandRequestProto
	(*ContainerCommandResponseProto)(nil),        // 9: hadoop.hdds.datanode.ContainerCommandResponseProto
	(*ContainerDataProto)(nil),                   // 10: hadoop.hdds.datanode.ContainerDataProto
	(*Container2BCSIDMapProto)(nil),              // 11: hadoop.hdds.datanode.Container2BCSIDMapProto
	(*CreateContainerRequestProto)(nil),          // 12: hadoop.hdds.datanode.CreateContainerRequestProto
	(*CreateContainerResponseProto)(nil),         // 13: hadoop.hdds.datanode.CreateContainerResponseProto
	(*ReadContainerRequestProto)(nil),            // 14: hadoop.hdds.datanode.ReadContainerRequestProto
	(*ReadContainerResponseProto)(nil),           // 15: hadoop.hdds.datanode.ReadContainerResponseProto
	(*UpdateContainerRequestProto)(nil),          // 16: hadoop.hdds.datanode.UpdateContainerRequestProto
	(*UpdateContainerResponseProto)(nil),         // 17: hadoop.hdds.datanode.UpdateContainerResponseProto
	(*DeleteContainerRequestProto)(nil),          // 18: hadoop.hdds.datanode.DeleteContainerRequestProto
	(*DeleteContainerResponseProto)(nil),         // 19: hadoop.hdds.datanode.DeleteContainerResponseProto
	(*ListContainerRequestProto)(nil),            // 20: hadoop.hdds.datanode.ListContainerRequestProto
	(*ListContainerResponseProto)(nil),           // 21: hadoop.hdds.datanode.ListContainerResponseProto
	(*CloseContainerRequestProto)(nil),           // 22: hadoop.hdds.datanode.CloseContainerRequestProto
	(*CloseContainerResponseProto)(nil),          // 23: hadoop.hdds.datanode.CloseContainerResponseProto
	(*BlockData)(nil),                            // 24: hadoop.hdds.datanode.BlockData
	(*PutBlockRequestProto)(nil),                 // 25: hadoop.hdds.datanode.PutBlockRequestProto
	(*PutBlockResponseProto)(nil),                // 26: hadoop.hdds.datanode.PutBlockResponseProto
	(*GetBlockRequestProto)(nil),                 // 27: hadoop.hdds.datanode.GetBlockRequestProto
	(*GetBlockResponseProto)(nil),                // 28: hadoop.hdds.datanode.GetBlockResponseProto
	(*DeleteBlockRequestProto)(nil),              // 29: hadoop.hdds.datanode.DeleteBlockRequestProto
	(*GetCommittedBlockLengthRequestProto)(nil),  // 30: hadoop.hdds.datanode.GetCommittedBlockLengthRequestProto
	(*GetCommittedBlockLengthResponseProto)(nil), // 31: hadoop.hdds.datanode.GetCommittedBlockLengthResponseProto
	(*DeleteBlockResponseProto)(nil),             // 32: hadoop.hdds.datanode.DeleteBlockResponseProto
	(*ListBlockRequestProto)(nil),                // 33: hadoop.hdds.datanode.ListBlockRequestProto
	(*ListBlockResponseProto)(nil),               // 34: hadoop.hdds.datanode.ListBlockResponseProto
	(*ChunkInfo)(nil),                            // 35: hadoop.hdds.datanode.ChunkInfo
	(*ChunkInfoList)(nil),                        // 36: hadoop.hdds.datanode.ChunkInfoList
	(*ChecksumData)(nil),                         // 37: hadoop.hdds.datanode.ChecksumData
	(*WriteChunkRequestProto)(nil),               // 38: hadoop.hdds.datanode.WriteChunkRequestProto
	(*WriteChunkResponseProto)(nil),              // 39: hadoop.hdds.datanode.WriteChunkResponseProto
	(*ReadChunkRequestProto)(nil),                // 40: hadoop.hdds.datanode.ReadChunkRequestProto
	(*ReadChunkResponseProto)(nil),               // 41: hadoop.hdds.datanode.ReadChunkResponseProto
	(*DataBuffers)(nil),                          // 42: hadoop.hdds.datanode.DataBuffers
	(*DeleteChunkRequestProto)(nil),              // 43: hadoop.hdds.datanode.DeleteChunkRequestProto
	(*DeleteChunkResponseProto)(nil),             // 44: hadoop.hdds.datanode.DeleteChunkResponseProto
	(*ListChunkRequestProto)(nil),                // 45: hadoop.hdds.datanode.ListChunkRequestProto
	(*ListChunkResponseProto)(nil),               // 46: hadoop.hdds.datanode.ListChunkResponseProto
	(*PutSmallFileRequestProto)(nil),             // 47: hadoop.hdds.datanode.PutSmallFileRequestProto
	(*PutSmallFileResponseProto)(nil),            // 48: hadoop.hdds.datanode.PutSmallFileResponseProto
	(*GetSmallFileRequestProto)(nil),             // 49: hadoop.hdds.datanode.GetSmallFileRequestProto
	(*GetSmallFileResponseProto)(nil),            // 50: hadoop.hdds.datanode.GetSmallFileResponseProto
	(*CopyContainerRequestProto)(nil),            // 51: hadoop.hdds.datanode.CopyContainerRequestProto
	(*CopyContainerResponseProto)(nil),           // 52: hadoop.hdds.datanode.CopyContainerResponseProto
	nil,                                          // 53: hadoop.hdds.datanode.Container2BCSIDMapProto.Container2BCSIDEntry
}
var file_DatanodeClientProtocol_proto_depIdxs = []int32{
	...
	12, // 1: hadoop.hdds.datanode.ContainerCommandRequestProto.createContainer:type_name -> hadoop.hdds.datanode.CreateContainerRequestProto
	14, // 2: hadoop.hdds.datanode.ContainerCommandRequestProto.readContainer:type_name -> hadoop.hdds.datanode.ReadContainerRequestProto
	16, // 3: hadoop.hdds.datanode.ContainerCommandRequestProto.updateContainer:type_name -> hadoop.hdds.datanode.UpdateContainerRequestProto
	18, // 4: hadoop.hdds.datanode.ContainerCommandRequestProto.deleteContainer:type_name -> hadoop.hdds.datanode.DeleteContainerRequestProto
	20, // 5: hadoop.hdds.datanode.ContainerCommandRequestProto.listContainer:type_name -> hadoop.hdds.datanode.ListContainerRequestProto
	22, // 6: hadoop.hdds.datanode.ContainerCommandRequestProto.closeContainer:type_name -> hadoop.hdds.datanode.CloseContainerRequestProto
	25, // 7: hadoop.hdds.datanode.ContainerCommandRequestProto.putBlock:type_name -> hadoop.hdds.datanode.PutBlockRequestProto
	27, // 8: hadoop.hdds.datanode.ContainerCommandRequestProto.getBlock:type_name -> hadoop.hdds.datanode.GetBlockRequestProto
	29, // 9: hadoop.hdds.datanode.ContainerCommandRequestProto.deleteBlock:type_name -> hadoop.hdds.datanode.DeleteBlockRequestProto
	33, // 10: hadoop.hdds.datanode.ContainerCommandRequestProto.listBlock:type_name -> hadoop.hdds.datanode.ListBlockRequestProto
	40, // 11: hadoop.hdds.datanode.ContainerCommandRequestProto.readChunk:type_name -> hadoop.hdds.datanode.ReadChunkRequestProto
	38, // 12: hadoop.hdds.datanode.ContainerCommandRequestProto.writeChunk:type_name -> hadoop.hdds.datanode.WriteChunkRequestProto
	43, // 13: hadoop.hdds.datanode.ContainerCommandRequestProto.deleteChunk:type_name -> hadoop.hdds.datanode.DeleteChunkRequestProto
	45, // 14: hadoop.hdds.datanode.ContainerCommandRequestProto.listChunk:type_name -> hadoop.hdds.datanode.ListChunkRequestProto
	47, // 15: hadoop.hdds.datanode.ContainerCommandRequestProto.putSmallFile:type_name -> hadoop.hdds.datanode.PutSmallFileRequestProto
	49, // 16: hadoop.hdds.datanode.ContainerCommandRequestProto.getSmallFile:type_name -> hadoop.hdds.datanode.GetSmallFileRequestProto
	30, // 17: hadoop.hdds.datanode.ContainerCommandRequestProto.getCommittedBlockLength:type_name -> hadoop.hdds.datanode.GetCommittedBlockLengthRequestProto
	...
	13, // 20: hadoop.hdds.datanode.ContainerCommandResponseProto.createContainer:type_name -> hadoop.hdds.datanode.CreateContainerResponseProto
	15, // 21: hadoop.hdds.datanode.ContainerCommandResponseProto.readContainer:type_name -> hadoop.hdds.datanode.ReadContainerResponseProto
	17, // 22: hadoop.hdds.datanode.ContainerCommandResponseProto.updateContainer:type_name -> hadoop.hdds.datanode.UpdateContainerResponseProto
	19, // 23: hadoop.hdds.datanode.ContainerCommandResponseProto.deleteContainer:type_name -> hadoop.hdds.datanode.DeleteContainerResponseProto
	21, // 24: hadoop.hdds.datanode.ContainerCommandResponseProto.listContainer:type_name -> hadoop.hdds.datanode.ListContainerResponseProto
	23, // 25: hadoop.hdds.datanode.ContainerCommandResponseProto.closeContainer:type_name -> hadoop.hdds.datanode.CloseContainerResponseProto
	26, // 26: hadoop.hdds.datanode.ContainerCommandResponseProto.putBlock:type_name -> hadoop.hdds.datanode.PutBlockResponseProto
	28, // 27: hadoop.hdds.datanode.ContainerCommandResponseProto.getBlock:type_name -> hadoop.hdds.datanode.GetBlockResponseProto
	32, // 28: hadoop.hdds.datanode.ContainerCommandResponseProto.deleteBlock:type_name -> hadoop.hdds.datanode.DeleteBlockResponseProto
	34, // 29: hadoop.hdds.datanode.ContainerCommandResponseProto.listBlock:type_name -> hadoop.hdds.datanode.ListBlockResponseProto
	39, // 30: hadoop.hdds.datanode.ContainerCommandResponseProto.writeChunk:type_name -> hadoop.hdds.datanode.WriteChunkResponseProto
	41, // 31: hadoop.hdds.datanode.ContainerCommandResponseProto.readChunk:type_name -> hadoop.hdds.datanode.ReadChunkResponseProto
	44, // 32: hadoop.hdds.datanode.ContainerCommandResponseProto.deleteChunk:type_name -> hadoop.hdds.datanode.DeleteChunkResponseProto
	46, // 33: hadoop.hdds.datanode.ContainerCommandResponseProto.listChunk:type_name -> hadoop.hdds.datanode.ListChunkResponseProto
	48, // 34: hadoop.hdds.datanode.ContainerCommandResponseProto.putSmallFile:type_name -> hadoop.hdds.datanode.PutSmallFileResponseProto
	50, // 35: hadoop.hdds.datanode.ContainerCommandResponseProto.getSmallFile:type_name -> hadoop.hdds.datanode.GetSmallFileResponseProto
	31, // 36: hadoop.hdds.datanode.ContainerCommandResponseProto.getCommittedBlockLength:type_name -> hadoop.hdds.datanode.GetCommittedBlockLengthResponseProto
	7,  // 37: hadoop.hdds.datanode.ContainerDataProto.metadata:type_name -> hadoop.hdds.datanode.KeyValue
	5,  // 38: hadoop.hdds.datanode.ContainerDataProto.state:type_name -> hadoop.hdds.datanode.ContainerDataProto.State
	2,  // 39: hadoop.hdds.datanode.ContainerDataProto.containerType:type_name -> hadoop.hdds.datanode.ContainerType
	53, // 40: hadoop.hdds.datanode.Container2BCSIDMapProto.container2BCSID:type_name -> hadoop.hdds.datanode.Container2BCSIDMapProto.Container2BCSIDEntry
	7,  // 41: hadoop.hdds.datanode.CreateContainerRequestProto.metadata:type_name -> hadoop.hdds.datanode.KeyValue
	2,  // 42: hadoop.hdds.datanode.CreateContainerRequestProto.containerType:type_name -> hadoop.hdds.datanode.ContainerType
	10, // 43: hadoop.hdds.datanode.ReadContainerResponseProto.containerData:type_name -> hadoop.hdds.datanode.ContainerDataProto
	7,  // 44: hadoop.hdds.datanode.UpdateContainerRequestProto.metadata:type_name -> hadoop.hdds.datanode.KeyValue
	10, // 45: hadoop.hdds.datanode.ListContainerResponseProto.containerData:type_name -> hadoop.hdds.datanode.ContainerDataProto
	6,  // 46: hadoop.hdds.datanode.BlockData.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	7,  // 47: hadoop.hdds.datanode.BlockData.metadata:type_name -> hadoop.hdds.datanode.KeyValue
	35, // 48: hadoop.hdds.datanode.BlockData.chunks:type_name -> hadoop.hdds.datanode.ChunkInfo
	24, // 49: hadoop.hdds.datanode.PutBlockRequestProto.blockData:type_name -> hadoop.hdds.datanode.BlockData
	31, // 50: hadoop.hdds.datanode.PutBlockResponseProto.committedBlockLength:type_name -> hadoop.hdds.datanode.GetCommittedBlockLengthResponseProto
	6,  // 51: hadoop.hdds.datanode.GetBlockRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	24, // 52: hadoop.hdds.datanode.GetBlockResponseProto.blockData:type_name -> hadoop.hdds.datanode.BlockData
	6,  // 53: hadoop.hdds.datanode.DeleteBlockRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	6,  // 54: hadoop.hdds.datanode.GetCommittedBlockLengthRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	6,  // 55: hadoop.hdds.datanode.GetCommittedBlockLengthResponseProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	24, // 56: hadoop.hdds.datanode.ListBlockResponseProto.blockData:type_name -> hadoop.hdds.datanode.BlockData
	7,  // 57: hadoop.hdds.datanode.ChunkInfo.metadata:type_name -> hadoop.hdds.datanode.KeyValue
	37, // 58: hadoop.hdds.datanode.ChunkInfo.checksumData:type_name -> hadoop.hdds.datanode.ChecksumData
	35, // 59: hadoop.hdds.datanode.ChunkInfoList.chunks:type_name -> hadoop.hdds.datanode.ChunkInfo
	3,  // 60: hadoop.hdds.datanode.ChecksumData.type:type_name -> hadoop.hdds.datanode.ChecksumType
	6,  // 61: hadoop.hdds.datanode.WriteChunkRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	35, // 62: hadoop.hdds.datanode.WriteChunkRequestProto.chunkData:type_name -> hadoop.hdds.datanode.ChunkInfo
	6,  // 63: hadoop.hdds.datanode.ReadChunkRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	35, // 64: hadoop.hdds.datanode.ReadChunkRequestProto.chunkData:type_name -> hadoop.hdds.datanode.ChunkInfo
	4,  // 65: hadoop.hdds.datanode.ReadChunkRequestProto.readChunkVersion:type_name -> hadoop.hdds.datanode.ReadChunkVersion
	6,  // 66: hadoop.hdds.datanode.ReadChunkResponseProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	35, // 67: hadoop.hdds.datanode.ReadChunkResponseProto.chunkData:type_name -> hadoop.hdds.datanode.ChunkInfo
	42, // 68: hadoop.hdds.datanode.ReadChunkResponseProto.dataBuffers:type_name -> hadoop.hdds.datanode.DataBuffers
	6,  // 69: hadoop.hdds.datanode.DeleteChunkRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	35, // 70: hadoop.hdds.datanode.DeleteChunkRequestProto.chunkData:type_name -> hadoop.hdds.datanode.ChunkInfo
	6,  // 71: hadoop.hdds.datanode.ListChunkRequestProto.blockID:type_name -> hadoop.hdds.datanode.DatanodeBlockID
	35, // 72: hadoop.hdds.datanode.ListChunkResponseProto.chunkData:type_name -> hadoop.hdds.datanode.ChunkInfo
	25, // 73: hadoop.hdds.datanode.PutSmallFileRequestProto.block:type_name -> hadoop.hdds.datanode.PutBlockRequestProto
	35, // 74: hadoop.hdds.datanode.PutSmallFileRequestProto.chunkInfo:type_name -> hadoop.hdds.datanode.ChunkInfo
	31, // 75: hadoop.hdds.datanode.PutSmallFileResponseProto.committedBlockLength:type_name -> hadoop.hdds.datanode.GetCommittedBlockLengthResponseProto
	27, // 76: hadoop.hdds.datanode.GetSmallFileRequestProto.block:type_name -> hadoop.hdds.datanode.GetBlockRequestProto
	4,  // 77: hadoop.hdds.datanode.GetSmallFileRequestProto.readChunkVersion:type_name -> hadoop.hdds.datanode.ReadChunkVersion
	41, // 78: hadoop.hdds.datanode.GetSmallFileResponseProto.data:type_name -> hadoop.hdds.datanode.ReadChunkResponseProto
	8,  // 79: hadoop.hdds.datanode.XceiverClientProtocolService.send:input_type -> hadoop.hdds.datanode.ContainerCommandRequestProto
	51, // 80: hadoop.hdds.datanode.IntraDatanodeProtocolService.download:input_type -> hadoop.hdds.datanode.CopyContainerRequestProto
	9,  // 81: hadoop.hdds.datanode.XceiverClientProtocolService.send:output_type -> hadoop.hdds.datanode.ContainerCommandResponseProto
	52, // 82: hadoop.hdds.datanode.IntraDatanodeProtocolService.download:output_type -> hadoop.hdds.datanode.CopyContainerResponseProto
...
func file_DatanodeClientProtocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_DatanodeClientProtocol_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
		...
		file_DatanodeClientProtocol_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
	...
	file_DatanodeClientProtocol_proto_msgTypes[35].OneofWrappers = []interface{}{
		(*ReadChunkResponseProto_Data)(nil),
		(*ReadChunkResponseProto_DataBuffers)(nil),
	}
	type x struct{}
