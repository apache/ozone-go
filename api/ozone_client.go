...
// CreateOzoneClient TODO
func CreateOzoneClient(omHost string) (*OzoneClient, error) {
    client, err := omclient.CreateOmClient(omHost)
    if err != nil {
        return nil, err
    }
    return &OzoneClient{
        OmClient:       client,
        xceiverManager: dnClient.GetXceiverClientManagerInstance(),
	}, nil
}
