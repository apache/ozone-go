...
const (
    // AUTH_PROTOCOL_NONE TODO
    AUTH_PROTOCOL_NONE AuthProtocol = 0x00
    // AUTH_PROTOCOL_SASL TODO
...
// GetCalleeRPCRequestHeaderProto TODO
func GetCalleeRPCRequestHeaderProto(protocolName *string) *hadoop_common.RequestHeaderProto {
    ...
    return &hadoop_common.RequestHeaderProto{MethodName: &methodName, DeclaringClassProtocolName: protocolName,
        ClientProtocolVersion: &CLIENT_PROTOCOL_VERSION}
}

// CreateSimpleUGIProto TODO
